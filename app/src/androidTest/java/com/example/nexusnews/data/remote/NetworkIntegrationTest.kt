...
class NetworkIntegrationTest {
    ...
    fun `successful API call returns data`() = runTest {
        ...
        // When
        val result = networkDataSource.safeApiCall {
    ...
    @Test
    fun `401 error throws UnauthorizedException through interceptor chain`() = runTest {
        // Given
    ...
    @Test
    fun `server error with retry succeeds after temporary failure`() = runTest {
    ...
    @Test
    fun `rate limit error throws RateLimitException`() = runTest {
        // Given
    ...
    @Test
    fun `network error throws IOException through retry mechanism`() = runTest {
    ...
    @Test
    fun `malformed JSON response throws parsing error`() = runTest {
        // Given
