...
class BaseRepositoryTest {
    ...
    @Test
    fun `networkBoundResource emits loading then success`() = runTest {
        // When
    ...
    @Test
    fun `networkBoundResource emits error when network fails and no cache`() = runTest {
        // When
        repository.testNetworkBoundResource(
            localData = null,
            remoteData = "fresh",
    ...
    @Test
    fun `networkBoundResource uses cache when network fails`() = runTest {
        // When
        repository.testNetworkBoundResource(
            localData = "cached",
            remoteData = "fresh",
